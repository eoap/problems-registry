...
- Enhanced `FastAPI` integration with introducing facility exceptions to reduce boilerplate code.
- Added `headers` support in `FastAPI` exceptions, when needing to send auxiliary HTTP headers i.e. `Retry-After`
